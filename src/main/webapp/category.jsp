    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add-form" action="/CategoryServlet">
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="action" value="list" form="add-form" class="btn btn-primary" data-bs-dismiss="modal" onclick="addNewCategory()">ADD</button>
            </div>
        </div>
    </div>
</div>
